 ...
 * update_mechanism = 1  => Copy best performing player in neighborhood, in case of ties pick 
 * at random proportional with the strategy of top players
 * */

public class Vertex_1_1 extends Vertex
{
	...
	Vertex_1_1()
	{
		...
		setVertexNumber(Vertex_1_1.count);		
		Vertex_1_1.count++;
